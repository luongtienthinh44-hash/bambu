    ...
    <section class="challenge-network">
        <div class="challenge-hub-container">
            <div class="challenge-network-top">
                <div>
                    <p class="challenge-eyebrow">Global Challenge Network</p>
                    <h2>Where challenges become opportunities</h2>
                </div>
                <p class="challenge-network-description">Access a global network of innovation demand, solution capabilities and strategic partnerships</p>
            </div>
            <div class="challenge-network-grid">
                <div class="challenge-map-card"><img src="<?php echo esc_url( bambu_get_media_asset_url( 'challenge-hub/1bb0d.png' ) ); ?>" alt="Global innovation map"></div>
                <div class="challenge-territory">
                    <div class="challenge-territory-header">
                        <p class="challenge-eyebrow">Selected Innovation Territory</p>
                        <h3>Vietnam</h3>
                        <p>Access innovation demand, solution capabilities and collaboration opportunities across Vietnam's innovation ecosystem</p>
                    </div>
                    <div class="challenge-stats">
                        <div class="challenge-stat-card"><strong><?php echo esc_html( $active_challenges ); ?></strong><span>Active Challenges</span></div>
                        <div class="challenge-stat-card"><strong>42</strong><span>Open Programmes</span></div>
                    </div>
                    <div class="challenge-focus">
                        <p class="challenge-eyebrow">Leading Focus Areas</p>
                        <p>Smart city <span aria-hidden="true">•</span> Enterprise AI <span aria-hidden="true">•</span> Climate tech</p>
                    </div>
                    <a class="challenge-view-button" href="#challenge-directory">View challenges in this location <span aria-hidden="true">↘</span></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="challenge-directory" class="challenge-directory">
        <div class="challenge-hub-container">
            <div class="challenge-search-block">
                <label class="screen-reader-text" for="challenge-search">Search challenges</label>
                <div class="challenge-search-wrap">
                    ...
                    <input id="challenge-search" class="challenge-search-input" type="search" placeholder="Search by keyword, technology, industry or organization">
                </div>
                <div class="challenge-filter-pills" role="group" aria-label="Challenge categories">
                    <button class="challenge-filter-pill is-active" type="button" data-filter="all">All Challenges</button>
                    ...
                    <article class="challenge-card" data-category="<?php echo esc_attr( implode( ' ', array_unique( $category_slugs ) ) ); ?>" data-search="<?php echo esc_attr( $card_search ); ?>">
                        <div class="challenge-card-main">
                            ...
                            <div class="challenge-card-body">
                                ...
                                <p class="challenge-card-date">Posted <?php echo esc_html( get_the_date( 'F j, Y' ) ); ?></p>
