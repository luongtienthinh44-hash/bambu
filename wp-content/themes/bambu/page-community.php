...
<main id="primary" class="site-main innovation-intelligence-page community-page">
    ...
    <section class="community-search-section" aria-label="Search community content">
        <div class="community-container">
            <label class="screen-reader-text" for="community-search">Search community content</label>
            <div class="community-search-wrap">
                ...
                <input id="community-search" type="search" placeholder="Search by keyword, technology, industry or organization">
            </div>
            <div class="community-filter-pills" role="group" aria-label="Community content filters">
                <button class="is-active" type="button" data-filter="all">Opportunity Status <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M11.0827 5.25L6.99935 9.33333L2.91602 5.25" stroke="#9CA3AF" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
                <button type="button" data-filter="all">Territory <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M11.0827 5.25L6.99935 9.33333L2.91602 5.25" stroke="#9CA3AF" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
                <button type="button" data-filter="all">Categories <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M11.0827 5.25L6.99935 9.33333L2.91602 5.25" stroke="#9CA3AF" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
                <button type="button" data-filter="all">Sub-category <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M11.0827 5.25L6.99935 9.33333L2.91602 5.25" stroke="#9CA3AF" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
                <button type="button" data-filter="all">Financial Value <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M11.0827 5.25L6.99935 9.33333L2.91602 5.25" stroke="#9CA3AF" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
                <button type="button" data-filter="all">Accepts International Submissions <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M11.0827 5.25L6.99935 9.33333L2.91602 5.25" stroke="#9CA3AF" stroke-width="1.16667" stroke-linecap="round" stroke-linejoin="round"/></svg></button>
            </div>
        </div>
    </section>
    ...
    <section class="community-section community-news" data-content-section="news">
        <div class="community-container">
            <div class="community-section-header"><h2>News</h2><div class="community-section-actions"><div class="community-nav-controls"><button type="button" aria-label="Previous news"><img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/d7922.svg' ) ); ?>" alt=""></button><button type="button" aria-label="Next news"><img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/e808e.svg' ) ); ?>" alt=""></button></div><a href="<?php echo esc_url( home_url( '/insights-resources/' ) ); ?>">Read more <img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/57ffb.svg' ) ); ?>" alt=""></a></div></div>
            <div class="community-news-grid">
                <?php foreach ( $news_articles as $news ) : ?>
                    <article class="community-news-card" data-search="<?php echo esc_attr( strtolower( $news['title'] . ' ' . $news['topic'] ) ); ?>">
                        <div class="community-news-image"><img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/' . $news['image'] ) ); ?>" alt="<?php echo esc_attr( $news['title'] ); ?>"><span>For Member Only</span></div>
                        <div class="community-news-body">
                            ...
                            <div class="community-card-footer"><a href="<?php echo esc_url( home_url( '/insights-resources/' ) ); ?>">Read article <img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/read-article.svg' ) ); ?>" alt=""></a><span><?php echo esc_html( $news['read_time'] ); ?></span></div>
                        </div>
                    </article>
                <?php endforeach; ?>
            </div>
            <div class="community-show-more"><a href="<?php echo esc_url( home_url( '/insights-resources/' ) ); ?>">Show more articles <img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/144a8.svg' ) ); ?>" alt=""></a></div>
        </div>
    </section>

    <section class="community-section community-events" data-content-section="events">
        <div class="community-container">
            <div class="community-section-header"><h2>Events &amp; Webinars</h2><a href="<?php echo esc_url( home_url( '/events/' ) ); ?>">Explore more Events <span aria-hidden="true">↗</span></a></div>
            <div class="community-events-grid">
                <?php foreach ( $events as $event ) : ?>
                    <article class="community-event-card" data-search="<?php echo esc_attr( strtolower( $event['title'] . ' ' . implode( ' ', $event['meta'] ) ) ); ?>">
                        ...
                        <a class="community-event-action" href="<?php echo esc_url( home_url( '/contact-us/' ) ); ?>">Register now <img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/register-now.svg' ) ); ?>" alt=""></a>
                    </article>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <section class="community-section community-iotw" data-content-section="innovation">
        <div class="community-container">
            <div class="community-section-header"><h2>Innovation of the Week</h2><div class="community-section-actions"><div class="community-nav-controls"><button type="button" aria-label="Previous innovation"><img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/d7922.svg' ) ); ?>" alt=""></button><button type="button" aria-label="Next innovation"><img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/e808e.svg' ) ); ?>" alt=""></button></div><a href="<?php echo esc_url( home_url( '/insights-resources/' ) ); ?>">Read more <img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/57ffb.svg' ) ); ?>" alt=""></a></div></div>
            <article class="community-iotw-card"><div class="community-iotw-image"><img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/99d65.png' ) ); ?>" alt="Selex Motors Clean Mobility AI Platform"><span>INNOVATION OF THE WEEK</span></div><div class="community-iotw-content"><div><div class="community-tag-row"><span>Cleantech &amp; AI</span><span>Mobility</span><time>Updated July 2026</time></div><p class="community-kicker">FEATURED CASE • SELEX MOTORS</p><h3>How Selex Motors Scaled Their Clean Mobility AI Solution Across Southeast Asia</h3><p>Discover how an innovative mobility venture built a proprietary battery-swapping network and AI fleet platform, partnering with regional enterprises to drive net-zero logistics across urban transit hubs.</p></div><div class="community-card-footer"><a href="<?php echo esc_url( home_url( '/insights-resources/' ) ); ?>">Read full story <span aria-hidden="true">↗</span></a><span>6 min read • Case Study</span></div></div></article>
        </div>
    </section>

    <section class="community-section community-innovation-up" data-content-section="innovation">
        <div class="community-container">
            <div class="community-section-header"><h2>Innovation UP</h2><div class="community-section-actions"><div class="community-nav-controls"><button type="button" aria-label="Previous Innovation UP"><img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/d7922.svg' ) ); ?>" alt=""></button><button type="button" aria-label="Next Innovation UP"><img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/e808e.svg' ) ); ?>" alt=""></button></div><a href="<?php echo esc_url( home_url( '/insights-resources/' ) ); ?>">Read more <img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/57ffb.svg' ) ); ?>" alt=""></a></div></div>
            <div class="community-innovation-grid">
                <?php foreach ( $innovation_cards as $card ) : ?>
                    <article class="community-innovation-card" data-search="<?php echo esc_attr( strtolower( $card['title'] . ' ' . $card['tag'] . ' ' . $card['partner'] ) ); ?>"><div class="community-innovation-image"><img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/' . $card['image'] ) ); ?>" alt="<?php echo esc_attr( $card['alt'] ); ?>"><span><?php echo esc_html( $card['badge'] ); ?></span></div><div class="community-innovation-body"><div class="community-innovation-meta"><span><?php echo esc_html( $card['tag'] ); ?></span><time><?php echo esc_html( $card['duration'] ); ?></time></div><h3><?php echo esc_html( $card['title'] ); ?></h3><p><?php echo esc_html( $card['excerpt'] ); ?></p><div class="community-innovation-stats"><div><strong><?php echo esc_html( $card['value_one'] ); ?></strong><span><?php echo esc_html( $card['label_one'] ); ?></span></div><div><strong><?php echo esc_html( $card['value_two'] ); ?></strong><span><?php echo esc_html( $card['label_two'] ); ?></span></div></div><div class="community-card-footer"><span><?php echo esc_html( $card['partner'] ); ?></span><a href="<?php echo esc_url( home_url( '/insights-resources/' ) ); ?>">Read case study <img src="<?php echo esc_url( bambu_get_media_asset_url( 'community/read-case-study.svg' ) ); ?>" alt=""></a></div></div></article>
                <?php endforeach; ?>
            </div>
        </div>
    </section>
